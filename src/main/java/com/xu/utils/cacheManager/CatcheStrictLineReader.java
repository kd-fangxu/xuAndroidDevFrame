 ...
 * US_ASCII.
 */
class CatcheStrictLineReader implements Closeable {
	 ...
	 */
	public CatcheStrictLineReader(InputStream in, Charset charset) {
	 ...
	 */
	public CatcheStrictLineReader(InputStream in, int capacity, Charset charset) {
		...
		if (!(charset.equals(CatcheUtil.US_ASCII))) {
