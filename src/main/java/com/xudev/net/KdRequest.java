...
import com.xudev.net.engine.AbsCancelTask;
import com.xudev.net.engine.INetEngine;
import com.xudev.net.engine.NetEngineDefaultImpl;
import com.xudev.net.param.BaseRequestParams;
import com.xudev.net.provider.IBaseReqBeanProImp;
import com.xudev.net.provider.IRequestConfigStrProvider;
import com.xudev.net.provider.ReqBean;
import com.xudev.utils.string.PatternCheckUtils;
import com.xudev.utils.sys.SPUtils;
...
public class KdRequest {
     ...
     */
    public static void init(Context context, IBaseReqBeanProImp reqBeanProvider) {
    ...
    public synchronized static KdRequest getInstance() throws Exception {
        ...
        if (manager.reqBeanProvider == null) {
            throw new Exception("IBaseReqBeanProImp is null");
        }
     ...
     * @return
     */
    public synchronized static KdRequest getInstance(IBaseReqBeanProImp provider) {
        if (manager == null) {
            try {
                throw new Exception("KdRequest did not register");
            } catch (Exception e) {
